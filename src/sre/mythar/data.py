...
POLYSEMY_RULE = "Polysemy is permitted only where the senses share a documented semantic axis."
...
CLUSTERS: list[tuple[int, str, str, str, str, str]] = [
    ...
    (21, "te pa ro", "You-father-rest", "kinship", "Te pa ro ya", "Address to father in peace"),
    (
        22,
        "ma bro ya",
        "Mother-sibling-divine",
        "kinship",
        "Ma bro ya kra",
    ...
    (29, "bu ga re", "Come-carry-flow", "motion", "Bu ga re ya", "Journey: come, carry, flow"),
    (30, "le bu to", "Flow-come-hand", "motion", "Le bu to ro", "Flow comes to the hand"),
    (31, "wi bu ya", "Know-come-divine", "motion", "Wi bu ya kra", "Knowledge comes to the divine"),
    (32, "re ga kra", "Flow-carry-vital", "motion", "Re ga kra ro", "Vital flow of carrying"),
    (33, "su bu ro", "Good-come-rest", "motion", "Su bu ro ya", "The good comes to rest"),
    (34, "hi ga bo", "High-carry-earth", "motion", "Hi ga bo kra", "Carry high upon the earth"),
    (35, "wi ni su", "Know-name-good", "abstract", "Wi ni su ro", "Know the good name"),
    (36, "ve wi ro", "See-know-rest", "abstract", "Ve wi ro ya", "See and know at rest"),
    (37, "ni ya kra", "Name-divine-vital", "abstract", "Ni ya kra ro", "Divine vital name"),
    (
        38,
        "su ni ma",
        "Good-name-existence",
    ...
    (39, "ve ni ya", "See-name-divine", "abstract", "Ve ni ya kra", "See the divine name"),
    (
        40,
        "wi su ni ya",
        "Know-good-name-divine",
        "abstract",
        "Wi su ni ya ro",
    ...
    (42, "la wa re", "Light-water-flow", "nature", "La wa re ya", "Light upon flowing water"),
    (43, "bo hi la", "Earth-high-light", "nature", "Bo hi la kra", "Earth rises into high light"),
    (44, "wa bo nu", "Water-earth-breath", "nature", "Wa bo nu ro", "Water and earth breathe"),
    (45, "hi wa ga", "High-water-carry", "nature", "Hi wa ga ya", "High waters carry"),
    (46, "la bo ro", "Light-earth-rest", "nature", "La bo ro kra", "Light rests upon the earth"),
]
    ...
    "morphemes": [
        {
            ...
            "parts": [
                {"form": "lm/lam", "from": ["la", "ma"], "gloss": "light + existence/mother"},
                {
                    "form": "akra",
                    "from": ["akra", "kra"],
                    "gloss": "intensified vital force / heart-core",
                },
            ],
        },
        {
            ...
            },
            {
                ...
                "parts": [
                    {"form": "ka", "from": ["ka"], "gloss": "power / force"},
                    {
                        "form": "jya",
                        "from": ["jya", "j", "ya"],
                        "gloss": "self affirmed in divine call",
                    },
                ],
            },
            {
                ...
                "parts": [
                    {
                        "form": "mu",
                        "from": ["mu", "ma"],
                        "gloss": "mother-breath / deep existence (ma-class)",
                    },
        ...
        "morphemes": [
            {
                ...
                "parts": [
                    {"form": "qay", "from": ["qay"], "gloss": "rooted life / living force"},
                    {
                        "form": "tra",
                        "from": ["ta", "ra"],
                        "gloss": "this proclaimed / demonstrative call",
                    },
                ],
            },
            {
                ...
                "parts": [
                    {
                        "form": "vi",
                        "from": ["vi", "wi", "ve"],
                        "gloss": "inner sight / subtle knowing",
                    },
                ],
            },
            {
...
def _triad_cluster(
    ...
    morphemes = [
        {
            ...
            "gloss": gloss,
            "parts": [
                {"form": part, "from": roots, "gloss": pgloss} for part, roots, pgloss in parts
            ],
        }
    ...
    return {
        ...
        "compounds": [
            f"{f1.capitalize()} {f1[:2]}",
            f"{f2.capitalize()} {f2[:2]}",
            f"{f1.capitalize()} {f2}",
        ],
        "morphemes": morphemes,
        ...
        _triad_cluster(
            ...
            (
                ...
                (
                    "mikra",
                    "small vital-heart",
                    (p("mi", ["mi", "ni"], "small / spirit"), p("kra", ["kra"], "vital heart")),
                ),
                (
                    "talu",
                    "this-flow / present-movement",
                    (
                        p("ta", ["ta"], "this / demonstrative"),
                        p("lu", ["lu", "le"], "flow-light / movement"),
                    ),
                ),
            ),
            ["ya", "fo", "ra", "mi", "kra", "ta", "lu"],
            "gathering · small heart · present flow",
        ...
        _triad_cluster(
            ...
            (
                (
                    ...
                    "open-mother ground",
                    (
                        p("pla", ["pla", "pli"], "open plain"),
                        p("mu", ["mu", "ma"], "mother-breath / ground"),
                    ),
                ),
                (
                    "yafika",
                    "divine-truth-power",
                    (p("ya", ["ya"], "divine"), p("fi", ["fi"], "truth"), p("ka", ["ka"], "power")),
                ),
                ("torla", "gate-light", (p("tor", ["tor"], "gate"), p("la", ["la"], "light"))),
            ),
            ["pla", "mu", "ya", "fi", "ka", "tor", "la"],
            "mother-ground · truth-power · gate-light",
        ),
        _triad_cluster(
            67,
            ("kafro", "yami", "supla"),
            ...
            (
                (
                    "kafro",
                    "power-rest / force-peace",
                    (p("ka", ["ka"], "power"), p("fro", ["fro", "ro"], "force-rest")),
                ),
                (
                    "yami",
                    "divine small-being",
                    (p("ya", ["ya", "yo"], "motion"), p("mi", ["mi"], "small being")),
                ),
                (
                    "supla",
                    "good-open plain",
                    (p("su", ["su"], "good"), p("pla", ["pla"], "open plain")),
                ),
            ),
            ["ka", "fro", "ya", "mi", "su", "pla"],
            "power-rest · divine being · good plain",
        ),
        _triad_cluster(
            68,
            ("mufra", "lakyo", "tinara"),
            ...
            (
                (
                    "mufra",
                    "mother-breath proclamation",
                    (
                        p("mu", ["mu", "ma"], "mother-breath"),
                        p("fra", ["fra", "ra"], "proclamation"),
                    ),
                ),
                (
                    "lakyo",
                    "light-force-knowing",
                    (p("la", ["la"], "light"), p("kyo", ["kyo", "ki", "wi"], "force-knowing")),
                ),
                (
                    "tinara",
                    "child-name proclaimed",
                    (
                        p("ti", ["ti", "tik"], "child"),
                        p("na", ["na", "ni"], "name"),
                        p("ra", ["ra"], "proclaimed"),
            ...
            ["mu", "fra", "la", "kyo", "ti", "na", "ra"],
            "mother-breath · light-knowing · child-name",
        ),
        _triad_cluster(
            69,
            ("yorfa", "maklu", "sipra"),
            ...
            (
                (
                    ...
                    "force-blessing",
                    (
                        p("yor", ["yor", "yo", "ya"], "force-divine"),
                        p("fa", ["fa", "fu"], "blessing"),
                    ),
                ),
                (
                    "maklu",
                    "mother-existence-flow",
                    (p("ma", ["ma"], "mother"), p("klu", ["klu", "lu"], "existence-flow")),
                ),
                (
                    "sipra",
                    "good-proclaimed",
                    (p("si", ["si"], "good-see"), p("pra", ["pra", "ra"], "proclaimed")),
                ),
            ),
            ["yor", "fa", "ma", "klu", "si", "pra"],
            "force-blessing · mother-flow · good proclaimed",
        ),
        _triad_cluster(
            70,
            ("plika", "yofra", "tamu"),
            ...
            (
                (
                    "plika",
                    "open-power",
                    (p("pli", ["pli", "pla"], "open"), p("ka", ["ka"], "power")),
                ),
                (
                    "yofra",
                    "divine-proclamation",
                    (p("yo", ["yo", "ya"], "divine"), p("fra", ["fra", "ra"], "proclamation")),
                ),
                ("tamu", "this-mother", (p("ta", ["ta"], "this"), p("mu", ["mu", "ma"], "mother"))),
            ),
            ["pli", "ka", "yo", "fra", "ta", "mu"],
            "open power · divine proclaim · this-mother",
        ),
        _triad_cluster(
            71,
            ("kafya", "lorpa", "minu"),
            ...
            (
                (
                    "kafya",
                    "power-grace",
                    (p("ka", ["ka"], "power"), p("fya", ["fya", "ya"], "grace")),
                ),
                (
                    "lorpa",
                    "light-protect",
                    (p("lor", ["lor", "la"], "light"), p("pa", ["pa"], "protect")),
                ),
                (
                    "minu",
                    "small-spirit",
                    (p("mi", ["mi"], "small"), p("nu", ["nu", "ni"], "spirit / breath")),
                ),
            ),
            ["ka", "fya", "lor", "pa", "mi", "nu"],
            "grace-power · light-protect · small spirit",
        ),
        _triad_cluster(
            72,
            ("yupra", "makra", "silu"),
            ...
            (
                (
                    "yupra",
                    "divine-proclaimed",
                    (p("yu", ["yu", "ya"], "divine"), p("pra", ["pra", "ra"], "proclaimed")),
                ),
                ("makra", "mother-heart", (p("ma", ["ma"], "mother"), p("kra", ["kra"], "heart"))),
                (
                    "silu",
                    "good-flow-light",
                    (p("si", ["si", "su"], "good"), p("lu", ["lu", "la"], "flow-light")),
                ),
            ),
            ["yu", "pra", "ma", "kra", "si", "lu"],
            "divine proclaim · mother-heart · good flow",
        ),
        _triad_cluster(
            73,
            ("torfa", "yami", "plaku"),
            ...
            (
                (
                    "torfa",
                    "gate-blessing",
                    (p("tor", ["tor"], "gate"), p("fa", ["fa", "fu"], "blessing")),
                ),
                (
                    "yami",
                    "motion small-being",
                    (p("ya", ["ya"], "divine"), p("mi", ["mi"], "small being")),
                ),
                (
                    "plaku",
                    "open-power-place",
                    (p("pla", ["pla"], "open"), p("ku", ["ku", "ka"], "place-power")),
                ),
            ),
            ["tor", "fa", "ya", "mi", "pla", "ku"],
            "gate-blessing · divine being · open power-place",
        ),
        _triad_cluster(
            74,
            ("morka", "yaflu", "sipta"),
            ...
            (
                ...
                (
                    "yaflu",
                    "divine-flow",
                    (p("ya", ["ya"], "divine"), p("flu", ["flu", "lu"], "flow")),
                ),
                (
                    "sipta",
                    "good-this",
                    (p("si", ["si", "su"], "good"), p("pta", ["pta", "ta"], "this-place")),
                ),
            ),
            ["mor", "ka", "ya", "flu", "si", "pta"],
            "rising power · divine flow · good-this",
        ),
        _triad_cluster(
            75,
            ("lakra", "yomu", "tafra"),
            ...
            (
                ...
                (
                    "yomu",
                    "divine-mother",
                    (p("yo", ["yo", "ya"], "divine"), p("mu", ["mu", "ma"], "mother")),
                ),
                (
                    "tafra",
                    "this-proclaimed",
                    (p("ta", ["ta"], "this"), p("fra", ["fra", "ra"], "proclaimed")),
                ),
            ),
            ["la", "kra", "yo", "mu", "ta", "fra"],
            "light-heart · divine-mother · this proclaimed",
        ),
        _triad_cluster(
            76,
            ("plina", "yofka", "maru"),
            ...
            (
                (
                    "plina",
                    "open-name",
                    (p("pli", ["pli", "pla"], "open"), p("na", ["na", "ni"], "name")),
                ),
                (
                    "yofka",
                    "divine-craft-power",
                ...
                (
                    "maru",
                    "mother-rest",
                    (p("ma", ["ma"], "mother"), p("ru", ["ru", "ro"], "rest-flow")),
                ),
            ),
            ["pli", "na", "yo", "fi", "ka", "ma", "ru"],
            "open name · divine craft · mother rest",
        ),
        _triad_cluster(
            77,
            ("kafro", "yala", "sipro"),
            ...
            (
                (
                    "kafro",
                    "power-rest",
                    (p("ka", ["ka"], "power"), p("fro", ["fro", "ro"], "rest")),
                ),
                ("yala", "divine light", (p("ya", ["ya"], "motion"), p("la", ["la"], "light"))),
                (
                    "sipro",
                    "good-bearing",
                    (p("si", ["si", "su"], "good"), p("pro", ["pro", "por"], "bearing")),
                ),
            ),
            ["ka", "fro", "ya", "la", "si", "pro"],
            "power-rest · divine light · good bearing",
        ),
        _triad_cluster(
            78,
            ("mufya", "plaro", "tikna"),
            ...
            (
                (
                    "mufya",
                    "mother-grace",
                    (p("mu", ["mu", "ma"], "mother"), p("fya", ["fya", "ya"], "grace")),
                ),
                ("plaro", "open-rest", (p("pla", ["pla"], "open"), p("ro", ["ro"], "rest"))),
                (
                    "tikna",
                    "child-name",
                    (p("tik", ["tik", "ti"], "child"), p("na", ["na"], "name")),
                ),
            ),
            ["mu", "fya", "pla", "ro", "tik", "na"],
            "mother-grace · open rest · child-name",
        ),
        _triad_cluster(
            79,
            ("yokru", "lamfa", "sipla"),
            ...
            (
                (
                    "yokru",
                    "divine-heart-force",
                    (p("yo", ["yo"], "divine"), p("kru", ["kru", "kra"], "heart-force")),
                ),
                (
                    "lamfa",
                    "light-mother-blessing",
                    (
                        p("lam", ["lam", "la", "ma"], "light-mother"),
                        p("fa", ["fa", "fu"], "blessing"),
                    ),
                ),
                ("sipla", "good-open", (p("si", ["si", "su"], "good"), p("pla", ["pla"], "open"))),
            ),
            ["yo", "kru", "lam", "fa", "si", "pla"],
            "divine heart-force · mother-light bless · good open",
        ),
        _triad_cluster(
            80,
            ("makyo", "yupra", "torlu"),
            ...
            (
                (
                    "makyo",
                    "mother-knowing",
                    (p("ma", ["ma"], "mother"), p("kyo", ["kyo", "wi"], "knowing-force")),
                ),
                (
                    "yupra",
                    "divine-proclaimed",
            ...
            ["ma", "kyo", "yu", "pra", "tor", "lu"],
            "mother-knowing · divine proclaim · gate flow",
...
CLUSTERS_88_94: list[tuple[int, str, str, str, str, str]] = [
    ...
    (90, "sola luna fe", "Sun-moon-wind", "nature", "Sola luna fe kra", "Sun–moon–wind: sky cycle"),
    (
        91,
        "tem reka lo",
        "Time-change-love",
...
PROTO_WORLD = [
    ...
    {"mythar": "ma", "proto_world": "*ma- / *mama", "domain": "kinship", "note": "mother"},
    {
        ...
        "proto_world": "*di- / *ti-",
        "domain": "kinship",
        "note": "child / small / pure",
    },
    {"mythar": "ne", "proto_world": "*na- / *ni-", "domain": "kinship", "note": "near / kin"},
    {
        "mythar": "bro",
        "proto_world": "*bʰréh₂tēr",
        "domain": "kinship",
        "note": "brother / sibling",
    },
    ...
    {"mythar": "la", "proto_world": "*leuk-", "domain": "nature", "note": "light"},
    {
        ...
        "proto_world": "*ḱerd- / ka",
        "domain": "abstract",
        "note": "vital heart / essence",
    },
    {
        "mythar": "yu",
        "proto_world": "*yu- / *yeu-",
        "domain": "abstract",
        "note": "join / grace glide",
    },
    {
        "mythar": "ara",
        "proto_world": "*h₂er- / *ar-",
        "domain": "abstract",
        "note": "fit / craft / ground",
    },
    {
        "mythar": "ki",
        "proto_world": "*ḱei- / *keh₂-",
        "domain": "abstract",
        "note": "vital craft / power",
    },
    {"mythar": "yo", "proto_world": "*yeu- / *dyew-", "domain": "abstract", "note": "divine glide"},
    {
        "mythar": "fu",
        "proto_world": "*bʰeh₂- / fortune calque",
        "domain": "abstract",
        "note": "blessing",
    },
    {
        "mythar": "ua",
        "proto_world": "*wed- / *h₂ew-",
        "domain": "abstract",
        "note": "flow / existence",
    },
    ...
    {
        "mythar": "ra",
        "proto_world": "*h₂er- / *reH-",
        "domain": "abstract",
        "note": "proclaim / intensify",
    },
    {
        "mythar": "fi",
        "proto_world": "*h₁yes- / *weid-",
        "domain": "abstract",
        "note": "truth / verity",
    },
    {
        "mythar": "ebro",
        "proto_world": "*h₁egʰ- / *bʰer-",
        "domain": "abstract",
        "note": "emergence-carrier",
    },
    {"mythar": "pi", "proto_world": "*peh₂-", "domain": "abstract", "note": "seed / point / spark"},
    {
        "mythar": "qay",
        "proto_world": "*gʷeyh₃- / *kʷey-",
        "domain": "abstract",
        "note": "rooted life",
    },
    ...
    {
        "mythar": "no",
        "proto_world": "*sneud- / *h₃er-",
        "domain": "abstract",
        "note": "deep sleep / rest",
    },
    {
        "mythar": "du",
        "proto_world": "*dweh₂- / *gʷreh₂-",
        "domain": "abstract",
        "note": "two / heavy / bad",
    },
    ...
    {
        "mythar": "mica",
        "proto_world": "*sem- / *oi-no-",
        "domain": "abstract",
        "note": "one / single",
    },
    {
        "mythar": "ska",
        "proto_world": "*h₂ek- / *ḱer- / *h₂ḱmōn",
        "domain": "nature",
        "note": "stone / rock (PGC: former to-stone sense)",
    },
    {"mythar": "ula", "proto_world": "*h₂ew- / *dyew-", "domain": "nature", "note": "sky / above"},
    {
        "mythar": "fi",
        "proto_world": "*peh₂wr̥ / *h₁yes-",
        "domain": "nature",
        "note": "fire / sacred-verity (PGC axis intensity→purity)",
    },
    {
        "mythar": "duma",
        "proto_world": "*dwóh₁",
        "domain": "abstract",
        "note": "two / dual (split from du per PGC-5)",
    },
    {
        "mythar": "taga",
        "proto_world": "*steh₂-",
        "domain": "motion",
        "note": "stand (former ta foot/stand sense)",
    },
    {
        "mythar": "chi",
        "proto_world": "*ǵenh₁- / *tek-",
        "domain": "kinship",
        "note": "child / youth",
    },
    {
        "mythar": "loi",
        "proto_world": "*leubh- / *priH-",
        "domain": "kinship",
        "note": "friend / love-ally",
    },
    {
        "mythar": "sha",
        "proto_world": "*alyo- / *gʰosti-",
        "domain": "kinship",
        "note": "other / stranger",
    },
    ...
    {
        "mythar": "rama",
        "proto_world": "*ḱerd- / *meǵh₂-",
        "domain": "body",
        "note": "feeling-heart / many",
    },
    {"mythar": "ko", "proto_world": "*ost- / *ḱost-", "domain": "body", "note": "bone"},
    {
        "mythar": "peh",
        "proto_world": "*kʷer- / *dʰeh₁-",
        "domain": "motion",
        "note": "make / create",
    },
...
def _attach_cluster_governance(
    ...
    *,
    ...
    out["cra_governance"] = classify_cluster_governance(
        ...
        provenance_note=(str(meta.get("provenance_note")) if meta.get("provenance_note") else None),
    )
    return out
...
def build_lexicon_document() -> dict[str, Any]:
    ...
    for cid, forms_s, name, domain, phrase, interp in CLUSTERS_81_87 + CLUSTERS_88_94 + CLUSTERS_95:
        forms = forms_s.split()
        if cid <= 87:
            proposal = "K"
        elif cid <= 94:
